...
{
    public class InstructorListViewModel : De.SealingSchool.ViewModelBase.ViewModel
    {
        ...
        public InstructorListViewModel()
        {
            ...
            Instructors.CollectionChanged += Instructors_CollectionChanged;
        }

        void Instructors_CollectionChanged(object sender, System.Collections.Specialized.NotifyCollectionChangedEventArgs e)
        {
        ...
        {
            Instructors.Add(new InstructorViewModel(new Instructor()));
        }
    }
}
