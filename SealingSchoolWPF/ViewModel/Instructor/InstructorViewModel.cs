...
{
    /// <summary>
    /// ViewModel for Instructor
    /// @Author Benjamin Böcherer
    /// </summary>
    public class InstructorViewModel : ViewModel<SailingSchoolWPF.Model.Instructor>
    {
        #region ctor
        public InstructorViewModel(SailingSchoolWPF.Model.Instructor model)
            : base(model)
        {
        }
        #endregion
